...
To download all the time series data from an ABS catalogue number to your disk, and import the data to R as a single tidy data frame, use `read_abs()`. Here's an example with the monthly Labour Force survey, catalogue number 6202.0:
