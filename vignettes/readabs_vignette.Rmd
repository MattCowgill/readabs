...
If you want to visualise or analyse data in R, you will often need to tidy it first. In [tidy data](https://cran.r-project.org/web/packages/tidyr/vignettes/tidy-data.html):
