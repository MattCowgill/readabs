...
The `separate_series()` column also helps with step three, tidying the data. You use it in conjunction with `read_abs()` - see the examples below.
...
The `separate_series` function in is a helper function to separate the `series` column and remove extraneous symbols.
